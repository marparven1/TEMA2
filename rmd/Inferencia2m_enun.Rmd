...
Se pueden considerar varianzas iguales.

El estadístico utilizado, es el codiente de las cuasivarianzas, porque n es el mismo.
...
Vemos que en diferencia de medias, el 0 está contenido en el intervalo. Acepto.
...
Valor muy poco significativo, rechado H0, no existe igualdad de varianzas.

Tenemos que comparar la media de las dos muestras, con distintas varianzas.
...
```
Emplea la correción de continuidad, ya estmaos en la normal. De nuevo rechazamos la hipótesis nula y concluímos con que el jurado 1 está puntuando con más nota que el 2.
...
ananor(y)
```
La variable X no sigue una normal mientras que Y


Test de Mann-Whitney o Mann-Whitney-Wilconxon
